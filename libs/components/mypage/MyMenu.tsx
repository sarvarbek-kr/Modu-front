					...
					<Stack className={'section'} style={{ height: user.memberType === 'AGENT' ? '228px' : '153px' }}>
						...
						<List className={'sub-section'}>
							{user.memberType === 'AGENT' && (
								<>
									<ListItem className={pathname === 'addFurniture' ? 'focus' : ''}>
										<Link
											href={{
												pathname: '/mypage',
												query: { category: 'addFurniture' },
											}}
											scroll={false}
										>
											<div className={'flex-box'}>
												{category === 'addFurniture' ? (
									...
									<ListItem className={pathname === 'myFurnitures' ? 'focus' : ''}>
										<Link
											href={{
												pathname: '/mypage',
												query: { category: 'myFurnitures' },
											}}
											scroll={false}
										>
											<div className={'flex-box'}>
