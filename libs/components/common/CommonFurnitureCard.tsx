...
const CommonFurnitureCard = (props: FurnitureCardProps) => {
	...
	if (device === 'mobile') {
		return (
			<Stack className="common-card-box" key={furniture._id}>
				<Box
					component={'div'}
					className={'card-img'}
		...
		return (
			<Stack className="common-card-box">
...
export default CommonFurnitureCard;
